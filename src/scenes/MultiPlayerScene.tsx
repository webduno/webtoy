    ...
    try {
      ...
      if (selectedTemplate) {
        ...
        switch (selectedTemplate) {
          ...
          case 'garden_parkour':
            templateData = [{"position":[0,0,0],"rotation":[0,0,0],"scale":[2,2,2],"color":"ffffff"}, // Base structure
              ...
              {"position":[0,-1.02012500526454,-3.9312412755540858],"rotation":[-0.34117551994524165,0,0],"scale":[1,1,1],"color":"a6ff00"}] // Lime green platform
            break;
          ...
          case 'mountain_view':
            templateData = [
              ...
              {"position":[-2.8660796556340182,1.41758965070298,-8.726470145787204],"rotation":[0.4020646434799646,0.03241309769871829,0.05775280501309669],"scale":[1.0610646209389731,3.9862973195137816,1.0610646209389731],"color":"858593"}] // Mountain element
            break;
